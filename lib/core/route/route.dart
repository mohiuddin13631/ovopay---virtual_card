...
import 'package:ovopay/app/screens/top_up/view/topup_card_screen.dart';
...
class RouteHelper {
  ...
  static const String cardChargesAndFeesScreen = "/card_charges_fees_screen";
  static const String topUpCardScreen = "/top_up_card_screen";
  ...
  static List<GetPage> routes = [
    ...
    GetPage(
      name: chooseCardScreen,
      transitionDuration: const Duration(milliseconds: 400),
      page: () => ChooseCardScreen(),
      transition: Transition.fadeIn,
    ),
    GetPage(
      name: cardApplicationScreen,
      transitionDuration: const Duration(milliseconds: 400),
      page: () => CardApplicationScreen(isPhysicalCard: Get.arguments),
      transition: Transition.fadeIn,
    ),
    GetPage(
    ...
    GetPage(
      name: cardChargesAndFeesScreen,
      transitionDuration: const Duration(milliseconds: 400),
      page: () => CardChargesAndFeesScreen(),
      transition: Transition.fadeIn,
    ),
    GetPage(
