      ...
      child: Column(
        children: [
          ...
          Row(
            ...
            children: [
              MyAssetImageWidget(assetPath: MyIcons.pickupVan, width: 16, height: 16, isSvg: true),
              spaceSide(Dimensions.space3.w),
              Text("Ship in 5-7 business days ", style: MyTextStyle.bodyTextStyle1.copyWith(color: MyColor.black, fontSize: Dimensions.space15.sp),)
            ],
          ),
          spaceDown(Dimensions.space30.h),

          Text(MyStrings.physicalCard.tr, style: MyTextStyle.headerH3.copyWith(color: MyColor.black)),
          spaceDown(Dimensions.space4.h),
          Text(MyStrings.tapToPayAndATmWithdrawals.tr,style: MyTextStyle.bodyTextStyle1.copyWith(fontSize: 13.sp, color: MyColor.bodyText)),
        ],
      ),
    );
  }
